...
ax2.plot(xstep-0.4, ro, color='black', linewidth=1, ls='--', marker='_', markersize=5, markerfacecolor='w', markeredgewidth=2, markeredgecolor='black', alpha=0.6)
ax2.plot(xstep-0.2, rl, linestyle='', color=(1,0,0,0.5), marker='_', markersize=5, markerfacecolor=(1,0,0,0.5), markeredgewidth=2, markeredgecolor='black',alpha=0.6)
ax2.plot(xstep-0  , rc, color=(0,0,1,0.5), linestyle='', marker='_', markersize=5, markerfacecolor=(0,0,1,0.5), markeredgewidth=2, markeredgecolor='black',alpha=0.6)
ax2.plot(xstep+0.2, rn, color='gray',  linewidth=1, ls='--', marker='_', markerfacecolor=(0,0,0,0.2), markeredgewidth=2, markeredgecolor='black',alpha=0.6)
