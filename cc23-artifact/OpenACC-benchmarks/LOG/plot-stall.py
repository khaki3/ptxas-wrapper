...
# plt.bar(xstep-0.4, co+do+eo+po+to+so+no+ro+yo+xo, color='white', width=0.165, edgecolor='None')
# plt.bar(xstep-0.2, cl+dl+el+pl+tl+sl+nl+rl+yl+xl, color='white', width=0.165, edgecolor='None')
# plt.bar(xstep+0,   cc+dc+ec+pc+tc+sc+nc+rc+yc+xc, color='white', width=0.165, edgecolor='None')
# plt.bar(xstep+0.2, cn+dn+en+pn+tn+sn+nn+rn+yn+xn, color='white', width=0.165, edgecolor='None')
