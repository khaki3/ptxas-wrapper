...
plt.legend([0, 1, 2, 3], ['Original', 'NO LOAD', 'NO CORNER', 'PTXASW'], fontsize=18, ncol=4, bbox_to_anchor=(-1,-2), loc='lower center', columnspacing=1.0, handlelength=1, handletextpad=0.4,
        handler_map={
               0: LegendObject('white', 'black'),
               1: LegendObject((1,0,0,0.5), 'black'),
               2: LegendObject((0,0,1,0.5), 'black'),
               3: LegendObject((0,0,0,0.2), 'black', False, '//'),
            })
